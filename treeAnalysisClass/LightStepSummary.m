classdef LightStepSummary < AnalysisTree
    properties
        StartTime = 0;
        EndTime = 0;
    end
    ...
    methods
        function obj = LightStepSummary(cellData, dataSetName, params)
            if nargin < 3
            ...
            nameStr = [cellData.savedFileName ': ' dataSetName ': LightStepSummary'];
        ...
        function obj = doAnalysis(obj, cellData)
            ...
            for i=1:L %for each leaf node
                ...
                if strcmp(rootData.(rootData.ampModeParam), 'Cell attached')
                    %% Add spike timing to the leaves
